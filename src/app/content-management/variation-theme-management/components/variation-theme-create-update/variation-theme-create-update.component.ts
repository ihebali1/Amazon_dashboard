...
@Component({
  selector: 'vex-variation-theme-create-update',
  templateUrl: './variation-theme-create-update.component.html',
  styleUrls: ['./variation-theme-create-update.component.scss']
})
export class VariationThemeCreateUpdateComponent implements OnInit {
